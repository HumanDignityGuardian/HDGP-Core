...
| Repo | HDGP-Core |
| Branch | main |
| Commit (optional) | `666a25e4603862338880cf3912add11c159aab4e` (post–v1.0.2 attestation UTF-8 fix; re-verify if branch moved) |
...
- 2026-Q3 起按需走 CHIP/书面映射；无持续双仓文档同步义务。
...
| 仓库 | HDGP-Core |
| 分支 | main |
| 提交（可选） | `666a25e4603862338880cf3912add11c159aab4e`（v1.0.2 后 attestation 修复；若分支已前进发布前请复核） |
...
**下一步：** 见英文 **Next steps** 与中文 **下一步**（2026-Q3 若需 aligned 须 CHIP/书面映射）。
