...
> **Core v1.0.2** (2026-05-20): patch tag **`v1.0.2`** — public site (`core.hdgp-protocol.com`), `examples/`, CI validation, adopter-pack index, governance/docs backlog; **does not** alter this Gate G snapshot or the mainline pick.  
...
- **HDGP-Core `v1.0.2`** (2026-05-20): patch tag **`v1.0.2`** — site, examples, CI, governance-facing docs; **does not** change the pick or this snapshot.
...
- **HDGP-Core `v1.0.2`**（2026-05-20）：补丁标签 **`v1.0.2`** —— 站点、示例、CI、治理面向文档；**不**改变拣选与本快照。
...
> **Core v1.0.2**（2026-05-20）：补丁标签 **`v1.0.2`** —— 公开站点、示例、CI、治理面向文档；**不**改变 Gate G 快照与主系统拣选。  
