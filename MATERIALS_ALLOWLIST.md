...
> **Status**: Final; **open release `v1.0.0`** dated **2026-05-03** (Git tag `v1.0.0`); **patch `v1.0.1`** dated **2026-05-04** (Git tag `v1.0.1`) adds adoption-bundle files only (JSON Schema, `snippets/`, `docs/ADOPTION_STATEMENT_TEMPLATE.md`, `.gitignore`) — **does not** change the Meta-only pick scope below. **Final mainline→Core Meta-only pick** completed **2026-05-03** (mainline anchor `e60732ea78a29ddb168a41be8792dff96af5ee59`). PRE-GATE draft reviewed into this file. Traceability & mainline acceptance cross-reference: `docs/CORE_EXTRACT_SNAPSHOT.md`. **Ongoing relationship**: repositories **fully isolated** except **quarterly ethics alignment** (`docs/ethics/ETHICS_ALIGNMENT_ATTESTATION_YYYYQn.md` and CHIP/ethics process).  
...
> **状态**：定稿；**公开发布 `v1.0.0`**（**2026-05-03**，Git 标签 `v1.0.0`）；**补丁 `v1.0.1`**（**2026-05-04**，Git 标签 `v1.0.1`）仅增加采用侧配套文件（JSON Schema、`snippets/`、`docs/ADOPTION_STATEMENT_TEMPLATE.md`、`.gitignore`）——**不**改变下文 Meta-only 拣选范围。**终局 Meta-only 拣选**已于 **2026-05-03** 完成（主系统锚点 `e60732ea78a29ddb168a41be8792dff96af5ee59`）。PRE-GATE 草案已审阅定稿为本文件。可追溯及主系统验收交叉引用：`docs/CORE_EXTRACT_SNAPSHOT.md`。**持续关系**：双仓 **完全隔离运作**，仅保留 **季度伦理对齐**（`docs/ethics/ETHICS_ALIGNMENT_ATTESTATION_YYYYQn.md` 与 CHIP/伦理流程）。  
