...
> **Status**: Final; **open release `v1.0.0`** dated **2026-05-03** (Git tag `v1.0.0`); **patch `v1.0.1`** dated **2026-05-04** (Git tag `v1.0.1`); **patch `v1.0.2`** dated **2026-05-20** (Git tag `v1.0.2`) adds site/examples/CI/governance-facing materials. **Patch `v1.0.1`** adds adoption-bundle materials (JSON Schema, `snippets/`, `docs/ADOPTION_STATEMENT_TEMPLATE.md`, `docs/ADOPTION_BUNDLE.md`, `.gitignore`) and release-facing documentation (`README.md`, `docs/index.html`, this allowlist, `docs/CORE_EXTRACT_SNAPSHOT.md`) — **does not** change the Meta-only pick scope below. **Final mainline→Core Meta-only pick** completed **2026-05-03** (mainline anchor `e60732ea78a29ddb168a41be8792dff96af5ee59`). PRE-GATE draft reviewed into this file. Traceability & mainline acceptance cross-reference: `docs/CORE_EXTRACT_SNAPSHOT.md`. **Ongoing relationship**: repositories **fully isolated** except **quarterly ethics alignment** (`docs/ethics/ETHICS_ALIGNMENT_ATTESTATION_YYYYQn.md` and CHIP/ethics process).  
...
> **状态**：定稿；**公开发布 `v1.0.0`**（**2026-05-03**，Git 标签 `v1.0.0`）；**补丁 `v1.0.1`**（**2026-05-04**，Git 标签 `v1.0.1`）；**补丁 `v1.0.2`**（**2026-05-20**，Git 标签 `v1.0.2`）增加站点/示例/CI/治理面向材料。**补丁 `v1.0.1`** 增加采用侧配套（JSON Schema、`snippets/`、`docs/ADOPTION_STATEMENT_TEMPLATE.md`、`docs/ADOPTION_BUNDLE.md`、`.gitignore`）及面向发布的文档（`README.md`、`docs/index.html`、本白名单、`docs/CORE_EXTRACT_SNAPSHOT.md`）——**不**改变下文 Meta-only 拣选范围。**终局 Meta-only 拣选**已于 **2026-05-03** 完成（主系统锚点 `e60732ea78a29ddb168a41be8792dff96af5ee59`）。PRE-GATE 草案已审阅定稿为本文件。可追溯及主系统验收交叉引用：`docs/CORE_EXTRACT_SNAPSHOT.md`。**持续关系**：双仓 **完全隔离运作**，仅保留 **季度伦理对齐**（`docs/ethics/ETHICS_ALIGNMENT_ATTESTATION_YYYYQn.md` 与 CHIP/伦理流程）。  
